import { CurrencyDropDown } from "../Models/IRFQ";
...
export const constants = {
  ...
  const exchangeRateAPIKey="d90a2fb73b243e9effcbdd3b";
  const exchangeRateAPIURL=`https://v6.exchangerate-api.com/v6/${exchangeRateAPIKey}/latest`;
  const currencies:CurrencyDropDown[] = [
  ...
  const productImageURL=`${apiurl}/Common/productImages?filename=`;
  const clientcontractfile=`${apiurl}/Common/productImages?filename=`;
  const contractfile=`${apiurl}/Common/productImages?filename=`;
  const supplierimage=`${apiurl}/Common/productImages?filename=`;
  export const apiEndpoint = {
    ...
    SupplierImageURL:supplierimage,
    AuthEndpoint: {
      login: `${apiurl}/Account/Login`,
      register: `${apiurl}/Account/register`,
      logout: `${apiurl}/Account/logout`,
      loggedUser: `${apiurl}/Account/user`,
      getroles:`${apiurl}/Account/roles`
    },
    UserEndpoint:{
        getusers:`${apiurl}/User/users`,
        addrole:`${apiurl}/User/addrole`
    },
    ContractEndpoint:{
      getcontracts:`${apiurl}/Contract/getcontracts`,
      addcontract:`${apiurl}/Contract/addcontract`,
      getcontractbyid:`${apiurl}/Contract`,
      updatecontract:`${apiurl}/Contract/updatecontract`,
      deletecontract:`${apiurl}/Contract`,
    },
    CustomerEndpoint:{
      getcustomers:`${apiurl}/Customers/getcustomers`,
      addcustomer:`${apiurl}/Customers/addcustomer`,
      getcustomerbyid:`${apiurl}/Customers`,
      updatecustomer:`${apiurl}/Customers/updatecustomer`,
      deletecustomer:`${apiurl}/Customers`,
    },
    AddressEndpoint:{
      getcustomeraddresses:`${apiurl}/CustomerAddresses`,
      addcustomeraddress:`${apiurl}/CustomerAddresses`,
      getcustomeraddressbyid:`${apiurl}/CustomerAddresses`,
      updatecustomeraddress:`${apiurl}/CustomerAddresses`,
      deletecustomeraddress:`${apiurl}/CustomerAddresses`,
    },
    BankEndpoint:{
      getcustomerbanks:`${apiurl}/CustomerBanks`,
      addcustomerbank:`${apiurl}/CustomerBanks`,
      getcustomerbankbyid:`${apiurl}/CustomerBanks`,
      updatecustomerbank:`${apiurl}/CustomerBanks`,
      deletecustomerbank:`${apiurl}/CustomerBanks`,
    },
    ClientEndpoint:{
      getclients:`${apiurl}/Clients`,
      addclient:`${apiurl}/Clients`,
      getclientbyid:`${apiurl}/Clients`,
      updateclient:`${apiurl}/Clients`,
      deleteclient:`${apiurl}/Clients`,
      getclientcontracts:`${apiurl}/Clients/GetClientContracts`
    },
    ContractLogisticRateEndpoint:{
      getcontractlogisticrates:`${apiurl}/ContractLogisticRates`,
      addcontractlogisticrate:`${apiurl}/ContractLogisticRates`,
      getcontractlogisticratebyid:`${apiurl}/ContractLogisticRates`,
      updatecontractlogisticrate:`${apiurl}/ContractLogisticRates`,
      deletecontractlogisticrate:`${apiurl}/ContractLogisticRates`,
    },
    ContractQuoteRateEndpoint:{
      getcontractquoterates:`${apiurl}/ContractQuoteRates`,
      addcontractquoterate:`${apiurl}/ContractQuoteRates`,
      getcontractquoteratebyid:`${apiurl}/ContractQuoteRates`,
      updatecontractquoterate:`${apiurl}/ContractQuoteRates`,
      deletecontractquoterate:`${apiurl}/ContractQuoteRates`,
    },
    ProductEndpoint:{
    ...
    SupplierEndpoint:{
      getsuppliers:`${apiurl}/Suppliers`,
      addsupplier:`${apiurl}/Suppliers`,
      getsupplierbyid:`${apiurl}/Suppliers`,
      updatesupplier:`${apiurl}/Suppliers`,
      deletesupplier:`${apiurl}/Suppliers`,
    },
    QuoteEndpoint:{
      getquotes:`${apiurl}/Quotes`,
      addquote:`${apiurl}/Quotes`,
      getquotebyid:`${apiurl}/Quotes`,
      updatequote:`${apiurl}/Quotes`,
      deletequote:`${apiurl}/Quotes`,
    },
    RFQEndpoint:{
      getRFQs:`${apiurl}/RFQs`,
      addRFQ:`${apiurl}/RFQs`,
      getRFQbyid:`${apiurl}/RFQs`,
      updateRFQ:`${apiurl}/RFQs`,
      deleteRFQ:`${apiurl}/RFQs`,
    },
    ExchangeRateEndpoint:{
      getexchangerates:`${apiurl}/exchangerates`,
      addexchangerate:`${apiurl}/exchangerates`,
      getexchangeratebyid:`${apiurl}/exchangerates`,
      updateexchangerate:`${apiurl}/exchangerates`,
      deleteexchangerate:`${apiurl}/exchangerates`,
      getexchangeratelive:`${exchangeRateAPIURL}`
    }
  };